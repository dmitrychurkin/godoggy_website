...
var photoswipe_1 = __importDefault(__webpack_require__(/*! ./lib/photoswipe */ "./resources/ts/lib/photoswipe.ts"));
...
// };
exports.default = (function (imageUri) { return __awaiter(_this, void 0, void 0, function () {
    var items, pswpElement;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, loadImages(imageUri)];
            case 1:
                items = _a.sent();
                pswpElement = document.querySelector('.pswp');
                // Initializes and opens PhotoSwipe
                return [2 /*return*/, new photoswipe_1.default(pswpElement, photoswipe_ui_default_1.default, items, {})];
        }
    });
}); });
