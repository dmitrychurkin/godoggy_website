        ...
        <>
                                ...
                                return loginApi({ email: email.value, password: password.value, remember: remember.value || undefined })
                                    ...
                                    .catch(({ response }) => {
                                        if (typeof response.data === 'object') {
                                            ...
                                            setSnackbarState({ message: `${message} ${Object.values(errors).map(errArr => errArr.join(' '))}`, isOpen: true });
                                        }
            ...
            >
                <SnackbarContent
                    ...
                    action={[
                        <IconButton key="close" aria-label="Close" color="inherit" onClick={closeSnakbar}>
